...
if (!function_exists('ef_category_viewer_row')) {
    function ef_category_viewer_row($cat)
    {
        ...
        <div class="ef-category-row ef-category-viewer">
            <div class="ef-category-col-name"><?php echo esc_html($cat->name); ?></div>
            <div class="ef-category-col-visibility"><?php echo esc_html(ucfirst($cat->visibility ?? '')); ?></div>
            <div class="ef-category-col-description"><?php echo esc_html($cat->description); ?></div>
